...
<html lang="en">
  <head>
    <title>PLIL &mdash;Career Portal</title>
    <meta charset="utf-8">
    ...
    <header class="site-navbar mt-3">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="site-logo col-6"><a href="<?php echo APPURL; ?>">PLIL || JobBoard</a></div>
          ...
          <nav class="mx-auto site-navigation">
            <ul style="margin-right: -500px" class="site-menu js-clone-nav d-inline d-xl-block ml-0 pl-0">
              ...
              <li><a href="<?php echo APPURL; ?>/general/workers.php">Job Seekers</a></li>
              <li><a href="<?php echo APPURL; ?>/general/companies.php">Company</a></li>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="<?php echo APPURL; ?>/users/applied_jobs.php?id=<?php echo $_SESSION['id']; ?>">Applied Jobs</a>
            <?php endif; ?>
            <?php if(isset($_SESSION['type']) AND $_SESSION['type'] =="Company") : ?>
